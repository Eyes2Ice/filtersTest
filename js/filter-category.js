document.addEventListener('DOMContentLoaded', function() {
  // Элементы фильтра
  const categoryFilter = document.querySelector('.filter-group[data-filter="category"]');
  ...
  function updateSelectedCategoriesUI() {
    ...
    selectedCategories.forEach(categoryValue => {
      const checkbox = document.querySelector(`input[name="category"][value="${categoryValue}"]`);
      const categoryLabel = checkbox ? checkbox.nextElementSibling.nextElementSibling.textContent : categoryValue;
  ...
  function updateProductsCounter() {
    const visibleProducts = document.querySelectorAll('.catalog-list__item:not(.hidden)');
